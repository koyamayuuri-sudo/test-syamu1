      ...
      <table class="w-full border-collapse text-sm 2xl:text-base">
        ...
        <tbody>
          ...
          >
            ...
            <td class="p-3 text-center border-r border-gray-300 font-sans tabular-nums">{{ row.code }}</td>
            <td class="p-3 text-center border-r border-gray-300 font-sans">{{ row.name }}</td>
            <td class="p-3 text-right font-sans tabular-nums pr-8">{{ row.amount }}</td>
          </tr>
        </tbody>
      </table>
    </div>
