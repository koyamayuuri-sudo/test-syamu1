...
import PlaceCodeSelector from '../components/PlaceCodeSelector.vue';
...
const placeCode = ref('010-010');
const placeName = ref('祈祷所');
  ...
  <DashboardLayout :onSave="handleSave" :onPrint="handlePrint">
    ...
    <template #inputForm>
      <div class="flex flex-wrap items-center gap-6">
        ...
        <!-- 場所コード・名称 -->
        <PlaceCodeSelector v-model="placeCode" />
      ...
      <table class="w-full border-collapse text-sm 2xl:text-base">
        <thead>
          <tr class="border-b border-gray-400 bg-gray-100/70 font-bold text-gray-800">
            ...
            <th class="p-3.5 border-r border-gray-300 w-[20%] text-center">場所コード</th>
