...
const placeName = ref('場所名称');
const paymentMethod = ref('クレジットカード');
  ...
  <DashboardLayout :onSave="handleSave" :onPrint="handlePrint">
    ...
    <template #inputForm>
      <div class="flex flex-wrap items-center gap-y-3 gap-x-6">
        ...
        <!-- 支払い方法 -->
        <div class="flex items-center gap-2">
          <span class="font-bold text-gray-700">支払い方法</span>
          <div class="relative">
            <select
      ...
      <table class="w-full border-collapse text-sm 2xl:text-base">
        <thead>
          <tr class="border-b border-gray-400 bg-gray-100/70 font-bold text-gray-800">
            <th class="p-3.5 border-r border-gray-300 w-[18%] text-center">日付</th>
            <th class="p-3.5 border-r border-gray-300 w-[18%] text-center">場所コード</th>
            <th class="p-3.5 border-r border-gray-300 w-[24%] text-center">名称</th>
            <th class="p-3.5 border-r border-gray-300 w-[20%] text-center">支払い方法</th>
            <th class="p-3.5 text-center w-[20%]">金額</th>
          </tr>
        </thead>
        <tbody>
          <tr
