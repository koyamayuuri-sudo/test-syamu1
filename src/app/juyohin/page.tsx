...
export default function JyuyohinPage() {
  ...
  const handleAdd = () => {
    ...
    setDataList([
      ...dataList,
      { date, code: itemCode, name: itemName, count, amount: `${amount} 円` },
    ]);
  };
      ...
      <div className="flex flex-wrap items-center gap-y-3 gap-x-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <select
              ...
              className="bg-white border border-gray-400 rounded px-4 py-1 pr-8 text-center appearance-none shadow-inner font-sans"
            >
        ...
        <div className="flex items-center gap-2">
          ...
          <input
            ...
            className="bg-white border border-gray-400 rounded px-3 py-1 text-right w-24 shadow-inner font-sans"
          />
        </div>
